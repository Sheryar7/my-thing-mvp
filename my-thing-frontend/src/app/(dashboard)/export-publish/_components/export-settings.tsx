...
export function ExportSettings({
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs h-full flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3.5 py-2 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-indigo-500 transition-colors text-slate-800"
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-3.5 py-2 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-indigo-500 transition-colors text-slate-800 bg-white cursor-pointer"
            >
