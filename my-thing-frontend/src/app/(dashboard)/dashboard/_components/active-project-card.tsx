    ...
    return (
        <DashboardCard className="p-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between w-full">
            ...
            <Button
                ...
                className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg px-4 py-2 text-sm transition-colors duration-200 shadow-sm"
            >
                Continue →
            </Button>
        </DashboardCard>
